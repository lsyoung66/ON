...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/book">
    <html>
      <head>
        <title>
          <xsl:value-of select="./novel[@type='로맨스6']/title" />
        </title>
      </head>
      <body background="77.PNG">
        ...
        <header>
          <h1 align="center" style="font-family: 맑은 고딕; text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black; letter-spacing: 5px;">
            <font color="#be6060">
              <xsl:value-of select="./novel[@type='로맨스6']/title"></xsl:value-of>
            </font>
          </h1>
        </header>
        <br></br>
